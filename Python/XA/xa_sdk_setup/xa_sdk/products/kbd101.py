...
class KBD101(XADevice):
    """
    Thorlabs Kcube brushless DC servo controller. 
    """
    # Device properties.
    ...
    def set_kcube_io_trigger_params(self, trigger_one_mode: TLMC_KcubeIoTriggerMode,
                                    trigger_one_polarity:TLMC_KcubeIoTriggerPolarity,
                                    trigger_two_mode: TLMC_KcubeIoTriggerMode, 
                                    trigger_two_polarity:TLMC_KcubeIoTriggerPolarity):
        """
    ...
    def set_kcube_mmi_params(self, joystick_mode: TLMC_KcubeMmi_JoystickMode, 
                             joystick_velocity: int, joystick_acceleration: int,
                             joystick_direction_sense: TLMC_KcubeMmi_JoystickDirectionSense, 
                             position_one: int, position_two:int,
