...
class BBD30XCHANNEL(XADevice):
    """
    Thorlabs benchtop brushless DC servo motor channel
    """
    ...
    # Device specific methods motor types (moves and motor parameters)
    ...
    def get_io_configuration_params(self, port_number: int, max_wait_in_milliseconds: int):
        """
        Returns the IO configuration settings structure.
        """
    ...
    def get_io_position_trigger_enable_state(self, max_wait_in_milliseconds: int):
        """
        Returns the position trigger enable state.
        """
    ...
    def get_io_trigger_params(self, max_wait_in_milliseconds: int):
        """
        Returns the trigger settings structure.
        """
    ...
    def get_lcd_move_params(self, max_wait_in_milliseconds: int):
        """
        Returns the LCD move parameters. 
        """
        ret = self.native_api.get_lcd_move_params(
            self.device_handle, max_wait_in_milliseconds)
        return LcdMoveParams(ret)
    ...
    def get_trigger_params_for_dc_brushless(self, max_wait_in_milliseconds: int):
        ret = self.native_api.get_trigger_params_for_dc_brushless(
            self.device_handle, max_wait_in_milliseconds)
        return DCBrushlessTriggerParams(ret)
    ...
    def set_current_loop_params(self, loop_scenario: TLMC_CurrentLoopScenario, phase: TLMC_CurrentLoopPhase, 
                                ...
                                integral_dead_band: int, feed_fwrd: int):
        """
    ...
    def set_io_position_trigger_enable_state(self, new_enable_state: TLMC_IoPositionTriggerEnableState, max_wait_in_milliseconds: int):
    ...
    def set_io_trigger_params(self, trigger_in_mode: TLMC_IoTriggerInMode, trigger_in_polarity: TLMC_IoTriggerPolarity,
                              ...
                              trigger_out_polarity: TLMC_IoTriggerPolarity, trigger_out_forward_start_position: int, 
                              trigger_out_forward_interval: int, trigger_out_forward_number_of_pulses: int, 
                              trigger_out_reverse_start_position: int,trigger_out_reverse_interval: int, 
                              trigger_out_reverse_number_of_pulses: int, trigger_out_pulse_width: int, 
                              trigger_out_number_of_cycles: int):
    ...
    def set_joystick_params(self, low_gear_velocity: int, high_gear_velocity: int, 
                            low_gear_acceleration: int, high_gear_acceleration: int, 
                            direction_sense: TLMC_JoystickDirectionSense):
        self.native_api.set_joystick_params(self.device_handle, low_gear_velocity, high_gear_velocity, low_gear_acceleration,
                                            high_gear_acceleration, direction_sense)

    def set_lcd_move_params(self, knob_sensitivity: int, display_brightness: int, display_timeout: int,
                            display_dim_level: int):
        """
        Changes the LCD move parameters. 
        """
        self.native_api.set_lcd_move_params(self.device_handle, knob_sensitivity, display_brightness, display_timeout,
                                            display_dim_level)
    ...
    def set_motor_output_params(self, max_wait_in_milliseconds: int):
        """
    ...
    def set_position_loop_params(self, position_loop_scenario: TLMC_PositionLoopScenario, proportional: int, 
                                 ...
                                 derivative: int, servo_cycles: int, scale: int,
                                 velocity_feed_fwrd: int, acceleration_feed_fwrd: int, 
                                 error_limit: int):
        """
    ...
    def set_stage_axis_params(self, type_id: TLMC_StageAxis_TypeId, axis_id: TLMC_StageAxis_AxisId, part_number: int, 
                              serial_number: int, counts_per_unit: int, min_position: int, max_position: int,
    ...
    def set_trigger_params_for_dc_brushless(self, trigger_mode: TLMC_TriggerModesForDcBrushless):
        self.native_api.set_trigger_params_for_dc_brushless(
